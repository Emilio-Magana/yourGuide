      ...
      <div className="overflow-hidden rounded-2xl bg-white">
        ...
        <div className="flex flex-col gap-5 p-6">
            ...
            <div key="confirmNewPassWord">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full rounded-lg border px-4 py-3 pr-12 transition-colors focus:border-transparent focus:ring-2 focus:ring-blue-500 ${
                    isPasswordMismatch
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-headerBegBg to-headerEndBg p-3 font-medium text-white shadow-md transition-all hover:from-headerEndBg hover:to-headerBegBg hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
          >
