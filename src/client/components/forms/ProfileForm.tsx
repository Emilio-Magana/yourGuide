        ...
        <div className="flex flex-col place-items-start gap-3 duration-300 xs_window:place-items-center">
          ...
          {!isEditing ? (
            <button
              ...
              className="w-52 rounded-lg bg-sky-400 py-2 text-sm font-medium text-white shadow-md duration-300 hover:-translate-y-1 hover:drop-shadow-[0_4px_1.2px_rgb(8,47,73)]"
            >
              Edit Profile
            </button>
          ) : (
