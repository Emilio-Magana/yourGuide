  ...
  return (
    <div className="flex flex-col">
      ...
      <nav className="m_window:flex l_window:px-6 sticky top-0 z-10 hidden place-content-between bg-white px-2 py-3">
        <ul className="m_window:gap-3 l_window:gap-4 xl_window:gap-5 flex gap-2 text-blue-600 transition-all duration-300 ease-in-out">
        ...
        <Link
          to="/checkout/:tourId"
          className="rounded-3xl bg-blue-600 px-5 py-3 text-white"
        >
          Start Planning
        </Link>
      </nav>
